...
//Top
            NODETYPE ListTop(void)
            {
                //this call didn't work ..we have to use an object to perform the call therfore we used this
                //return ListNode<NODETYPE>::getData() ;
                if(!isEmpty())
